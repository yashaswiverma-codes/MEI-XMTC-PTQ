...
def _parse_features(features):
    ...
    features_key = np.zeros(len(all_features), dtype=int)
    features_value = np.zeros(len(all_features), dtype=float)
...
def _parse_features(features):
    features_key = np.array([], dtype=int)
    features_value = np.array([], dtype=float)
